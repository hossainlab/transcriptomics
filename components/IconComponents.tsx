...
export const RnaLogo = ({ className }: { className?: string }) => (
  <svg
...
export const CellsIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 4.5a4.5 4.5 0 11-4.5 4.5 4.5 4.5 0 014.5-4.5zm0 0v8.25m0 0a4.5 4.5 0 115.196-4.432M9 12.75a4.5 4.5 0 11-5.196-4.432" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6.75a4.5 4.5 0 11-4.5 4.5 4.5 4.5 0 014.5-4.5zm0 0v8.25m0 0a4.5 4.5 0 115.196-4.432M16.5 15a4.5 4.5 0 11-5.196-4.432" />
    </svg>
);
